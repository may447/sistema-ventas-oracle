...
public class MenuPrincipal {
    ...
    public void mostrar() {
        ...
        do {
            ...
            System.out.println("7. Registrar cliente (SP)");
            System.out.println("8. Actualizar teléfono cliente");
            System.out.println("9. Eliminar cliente");
            System.out.println("10. Registrar pedido");
            System.out.println("11. Registrar pedido (SP)");
            System.out.println("12. Listar pedidos");
            System.out.println("13. Actualizar pedido");
            System.out.println("14. Eliminar pedido");
            System.out.println("15. Listar pedidos con detalle");
    ...
    private void registrarClienteSP() {
        System.out.print("ID cliente: ");
        int id = leerEntero();
        System.out.print("Nombre: ");
        String nombre = sc.nextLine();
        ...
        boolean ok = controller.crearClienteSP(id, nombre, tel);
        System.out.println(ok ? "Cliente creado mediante SP." : "Error al crear cliente con SP.");
    }
    ...
    private void registrarPedidoSP() {
        System.out.print("ID cliente: ");
        int idCliente = leerEntero();
        ...
        boolean ok = controller.registrarPedidoSP(idCliente, idProducto, cantidad);
        System.out.println(ok ? "Pedido registrado mediante SP." : "Error al registrar pedido con SP.");
    }
    ...
    private void listarPedidosConDetalle() {
        List<PedidoDetalle> pedidos = controller.listarPedidosConDetalle();

        if (pedidos.isEmpty()) {
            System.out.println("No hay pedidos con detalle.");
            return;
        }

        System.out.println("\nID | CLIENTE | PRODUCTO | CANT | TOTAL | FECHA");
